...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleBindException(BindException e) {
        printCausedByException("handleBindException :: ", e);
        final ErrorResponse response = ErrorResponse.of(ErrorCode.INVALID_INPUT_VALUE, e.getBindingResult());
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }
    ...
    protected ResponseEntity<ErrorResponse> handleRuntimeException(RuntimeException e) {
        printCausedByException("handleRuntimeException :: ", e);
    ...
    protected ResponseEntity<ErrorResponse> handleNotFoundException(Exception e) {
        ...
        final ErrorResponse response = ErrorResponse.of(ErrorCode.NOT_FOUND_HANDLE_EXCEPTION);
        return new ResponseEntity<>(response, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
